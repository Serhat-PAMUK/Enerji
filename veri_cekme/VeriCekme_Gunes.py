...
# Hedef URL'yi açın
url = "https://www.enerjiatlasi.com/gunes-enerjisi-haritasi/turkiye"
driver.get(url)
...
kurulu_gucleri_xpath = '//*[@id="article"]/table/tbody/tr/td[3]'  # Tablo satırlarının ikinci hücresindeki kurulu güçleri almak için
...
for il, kurulu_guc in zip(iller, kurulu_gucleri):
    ...
    cur.execute("""
        INSERT INTO gunes_enerjisi (il, kurulu_guc)
        VALUES (%s, %s)
